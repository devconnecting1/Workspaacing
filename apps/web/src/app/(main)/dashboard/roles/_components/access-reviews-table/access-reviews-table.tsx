...
export function AccessReviewsTable({ table }: { table: ReactTable<DataTableFeatures, AccessReview> }) {
    ...
    <>
      ...
      <div className="flex items-center border-border/70 border-t p-4">
        <div className="text-muted-foreground text-sm">
          {t("roles.reviewShowingResults", { start, end, total: filteredRows.length })}
        </div>
